...
public class FileController extends BaseController{
    ...
    @Value("${app.file-access-base-url}")
    ...
    public JsonResult<Void> userAvatarUpload(MultipartFile file,
        ...
        //本地的写法
        String realPath = fileUploadDir + fileName;
        /**
        ...
        //将文件的下载路径写入数据库
        String fileAccessPath = fileAccessBaseUrl + fileName;
    ...
    public ResponseEntity<byte[]> fileUpload(@PathVariable("name") String fileName) throws IOException {
        //读取文件
        //本地读取路径的写法
        String downFilePath = fileUploadDir + fileName;
